...
export default class InpageAccountController extends IController {
  ...
  // Send message to and update metrimask.account object of all registered ports
  public sendInpageAccountAllPorts = (statusChangeReason: METRIMASK_ACCOUNT_CHANGE) => {
  ...
  private handleLongLivedConnection = (port: chrome.runtime.Port) => {
    ...
    */
    ...
    port.onMessage.addListener((msg: any) => {
      if (msg.type === MESSAGE_TYPE.GET_INPAGE_METRIMASK_ACCOUNT_VALUES) {
