...
export enum MESSAGE_TYPE {
  ...
  SEND_TOKENS_MRC721 = 'SEND_TOKENS_MRC721',
  SEND_MRC721_TOKENS_SUCCESS = 'SEND_MRC721_OKENS_SUCCESS',
  SEND_MRC721_TOKENS_FAILURE = 'SEND_MRC721_TOKENS_FAILURE',
  SEND_MRC_TOKENS = 'SEND_MRC_TOKENS',
  SEND_MRC721_TOKENS = 'SEND_MRC721_TOKENS',
  MRC_TOKENS_RETURN = 'MRC_TOKENS_RETURN',
  MRC721_TOKENS_RETURN = 'MRC721_TOKENS_RETURN',
  ADD_TOKEN = 'ADD_TOKEN',
  ADD_MRC721_TOKEN = 'ADD_MRC721_TOKEN',
  REMOVE_TOKEN = 'REMOVE_TOKEN',
  REMOVE_MRC721_TOKEN = 'REMOVE_MRC721_TOKEN',
  LOGOUT = 'LOGOUT',
  ...
  EXTERNAL_CONFIRM_SEND_TO_CONTRACT = 'EXTERNAL_CONFIRM_SEND_TO_CONTRACT',
  EXTERNAL_CONFIRM_SIGN_MESSAGE = 'EXTERNAL_CONFIRM_SIGN_MESSAGE',
  EXTERNAL_CONFIRMATION_PENDING = 'EXTERNAL_CONFIRMATION_PENDING',
  GET_PENDING_EXTERNAL_REQUEST = 'GET_PENDING_EXTERNAL_REQUEST',
  SAVE_SESSION_LOGOUT_INTERVAL = 'SAVE_SESSION_LOGOUT_INTERVAL',
  GET_DARK_MODE = 'GET_DARK_MODE',
  SAVE_DARK_MODE = 'SAVE_DARK_MODE',
  GET_DEVELOPER_MODE_ENABLED = 'GET_DEVELOPER_MODE_ENABLED',
  SAVE_DEVELOPER_MODE_ENABLED = 'SAVE_DEVELOPER_MODE_ENABLED',
  DEPLOY_CONTRACT = 'DEPLOY_CONTRACT',
  DEPLOY_CONTRACT_SUCCESS = 'DEPLOY_CONTRACT_SUCCESS',
  DEPLOY_CONTRACT_FAILURE = 'DEPLOY_CONTRACT_FAILURE',
  ...
  GET_NETWORK_EXPLORER_TOKEN_URL = 'GET_NETWORK_EXPLORER_TOKEN_URL',
  GET_NETWORK_EXPLORER_MRC721_URL = 'GET_NETWORK_EXPLORER_MRC721_URL',
  GET_NETWORK_ENDPOINT_OVERRIDES = 'GET_NETWORK_ENDPOINT_OVERRIDES',
  SAVE_NETWORK_ENDPOINT_OVERRIDE = 'SAVE_NETWORK_ENDPOINT_OVERRIDE',
  GET_NETWORK_RPC_CONFIGS = 'GET_NETWORK_RPC_CONFIGS',
  SAVE_NETWORK_RPC_CONFIG = 'SAVE_NETWORK_RPC_CONFIG',
  CLEAR_NETWORK_RPC_CONFIG = 'CLEAR_NETWORK_RPC_CONFIG',
  GET_REGTEST_ENABLED = 'GET_REGTEST_ENABLED',
  SAVE_REGTEST_ENABLED = 'SAVE_REGTEST_ENABLED',
  GET_FEE_RATE_TIERS = 'GET_FEE_RATE_TIERS',
  ...
  GET_MRX_USD_RATE = 'GET_MRX_USD_RATE',
  GET_MRC_TOKEN_LIST = 'GET_MRC_TOKEN_LIST',
  GET_MRC721_TOKEN_LIST = 'GET_MRC721_TOKEN_LIST',
  ...
  GET_MRC721_TOKEN_DETAILS = 'GET_MRC721_TOKEN_DETAILS',
  MRC_TOKEN_DETAILS_RETURN = 'MRC_TOKEN_DETAILS_RETURN',
  MRC721_TOKEN_DETAILS_RETURN = 'MRC721_TOKEN_DETAILS_RETURN',
...
export enum STORAGE {
  ...
  DARK_MODE = 'darkMode',
  NETWORK_ENDPOINT_OVERRIDES = 'networkEndpointOverrides',
  REGTEST_ENABLED = 'regtestEnabled',
  DEVELOPER_MODE_ENABLED = 'developerModeEnabled',
  NETWORK_RPC_CONFIGS = 'networkRpcConfigs',
}
